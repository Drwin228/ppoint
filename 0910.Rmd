...
web: MymathLab.com
officehours: Th  9:30 to 11:00 am and by appointment
office: '3460'
classroom: '4140'
...
![my logo](aa.png)  
 email: Francois.nguyen@saintpaul.edu  
 web: MymathLab.com  
 office hours: Th  9:30 to 11:00 am and by appointment   
 office: 3460  
 classroom: 4140  
 classhours: T 11:00 am to 1:50 pm  
#photo:
...
## `r meeting_headers[1]`: Review of Real Number
*Assignment*: 

1. Ch-1.1 to Ch-1.4


## `r meeting_headers[2]`: Equations, Linear Equations and Inequalities.
*Readings*: 
...
## `r meeting_headers[3]`: Chapter-03: Graphing
*Assignment*: 
...
## `r meeting_headers[4]`: Chapter-04: Solve Systems Of Linear Rquations and Inequalities
*Readings*: 
...
## `r meeting_headers[5]`: Chapter-05: Exponents and Polynonilas
*Readings*: 

1. [Bryan, Jennifer. 2016. \textit{Happy Git and GitHub for the UseR.} Chapters 1-16.](http://happygitwithr.com)  Read this carefully and follow its instructions to get set up with \textsf{R}, RStudio, Git, and GitHub on your laptop before we meet.

## `r meeting_headers[6]`: Chapter-06:Factoring Polinomials
*Readings*: 
...
```{r}
mm <- matrix(c(94,100,80,93,73,79,50,60,00,60),ncol=2,byrow=TRUE,
